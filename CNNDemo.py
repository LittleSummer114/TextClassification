...
def train(data,params):
    ...
    picturepath='data/'+params['dataset']+'/picture/'+params['model'] + '_' + params['mode']+'_'+temp+'_'+str(params['learning_rate'])+'_'+params['level']+'_'+str(params['max_features'])+'.jpg'
    plt.clf()
    plt.xlabel('Epoch')
...
def main():
    ...
    parser.add_argument('--model',default='BiGRU_CONCEPT_TWO_CNN',help='models to perform text classification, alternative:CNN/GRU/BiGRU/BiGRU_CONCEPT_Attention/BiGRU_Attention/BiGRU_CNN/BiGRU_CONCEPT_CNN/BiGRU_CONCEPT_TWO_CNN')
    parser.add_argument('--mode',default='train',help='mode, alternative:train/test/dev')
    parser.add_argument('--dataset',default='AG',help='datasets, alternative:TREC/MR/Travel')
    ...
    parser.add_argument('--epoch',default=5,type=int,help='hyper parameter')
    ...
    parser.add_argument('--num_layers', default=2, type=int, help='the number of layers in RNN')
    ...
    parser.add_argument('--filter_size',default=[2,3,4,5],type=int,nargs='+',help='hyper parameter')
    ...
    parser.add_argument('--gpu', default=3,type=int, help='hyper parameter')
