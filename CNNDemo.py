...
def main():
    ...
    parser.add_argument('--model',default='BiGRU_CNN',help='models to perform text classification, alternative:CNN_word/CNNCCA/BiLSTM/CNN2/CNN_char')
    parser.add_argument('--mode',default='train',help='mode, alternative:train/test/dev')
    parser.add_argument('--dataset',default='TREC',help='datasets, alternative:TREC/MR/Travel')
    ...
    parser.add_argument('--max_features', default=1000, type=int,help='word/char')
    ...
    parser.add_argument('--gpu', default=0,type=int, help='hyper parameter')
